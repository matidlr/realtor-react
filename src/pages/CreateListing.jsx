    ...
    <main className="max-w-md px-2 mx-auto">
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="flex">
            ...
            onClick={onChange} className={`mr-3 px-7 py-3 font-med text-sm uppercase
            ...
            onClick={onChange} className={`ml-3 px-7 py-3 font-med text-sm uppercase
            shadow-md rounded  hover:shadow-lg focus:shadow-lg active:shadow-lg 
            transition duration-150 ease-in-out w-full 
                  ...
                  <div className="flex space-x-6 justify-start mb-6">
                     <div className="">
                        ...
                        className="w-full px-4 py-2 text-xl
                         ...
                         border-gray-300 rounded transition first-letter:
          ...
          <div className="flex mb-6">
            ...
            <div className="flex items-center mb-6">
               ...
               <div className="flex w-full justify-center items-center space-x-6">
                  ...
                  value={regularPrice}
                  onChange={onChange} min="50" max="4000000000"
                  required 
                  className="w-50 px-4 py-2 text-xl text-gray-700 bg-white 
